...
export class AccessTokenEvents {
    constructor(args: { expiringNotificationTimeInSeconds: number });
...
export class MetadataService {
    ...
    // (undocumented)
    protected _getMetadataProperty(
        name: keyof OidcMetadata,
        optional?: boolean
...
export class OidcClient {
    ...
    // Warning: (ae-forgotten-export) The symbol "DeviceAuthorizationClient" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
